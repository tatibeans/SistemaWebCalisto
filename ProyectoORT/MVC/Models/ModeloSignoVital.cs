...
namespace MVC.Models
{
    public class ModeloSignoVital
    {
        ...
        [Range((double)0.00, (double)5.00, ErrorMessage = "Valor inválido.")]
        ...
        [Range((double)0.00, (double)45.00, ErrorMessage = "Valor inválido.")]
        [Display(Name = "Temperatura corporal")]
        public string Temperatura { get; set; }

        [Range((double)0.00, (double)500.00, ErrorMessage = "Valor inválido.")]
        [Display(Name = "Pulso")]
